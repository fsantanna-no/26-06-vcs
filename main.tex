...
of a few companies (e.g., Meta and X), which control moderation and monetize
user data over closed protocols~\cite{internet.fixing,p2p.dosn}.
%
...
Sybils~\cite{p2p.sybil,p2p.mastodon}, since membership is decentralized.
%

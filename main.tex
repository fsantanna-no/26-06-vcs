...
$ fc /chat like 5000 author carol --sign=alice
$ fc /chat reps authors
bob        25000
alice      20000
carol       4500
...
$ fc /chat reps author carol     # T0: before post
4500
$ fc /chat post 'Nice Post' --sign=carol
1a5c8e21d934e6a44e47f72f188250faeaf0a6de
$ fc /chat reps author carol     # T1: after post
4000
$ fc /chat reps author carol     # T2: after 12h
4500
$ fc /chat reps author carol     # T3: after 24h
5500
\end{lstlisting}
...
$ fc /chat reps author carol
4500

# PEER I
$ fc /chat like 4500 author xion --sign=carol
...
# PEER J
$ fc /chat like 4500 author york --sign=carol
...
Our idea to stablish consensus in forum DAGs is to favor forks with posts from
members that constitute the majority of the reputation.
These forks have more associated work from active members and are analogous to
longest chains in Bitcoin.
%
When faced with a fork, the key detail is to account only the reputations in

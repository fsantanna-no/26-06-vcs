...
ensures strong eventual consistency (SEC)~\cite{fed.matrix,p2p.byz}.
%
The operation of the protocol is simple: an author posts to a chain, which
subscribed peers eventually receive by gossiping and synchronizing their DAGs.

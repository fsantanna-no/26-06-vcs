...
\item[T1:] The new post costs \nreps{500} (\R{2}), which limits how often
    she can post.
\item[T2:] The cost is refunded within 12 hours (\R{2}), or sooner as other
...
%
Since the post consolidates without being revoked (\S\ref{sec.design.votes}),
\emph{Carol} earns \nreps{1000}, which reflects the value she added to the
chain in the form of human-authored content.
...
Identity splitting   & proof-of-authoring, revocation   & \ref{sec.design.poa} \\

...
Unlike classic Byzantine agreement with permissioned quorums~\cite{p2p.byz},
...
%
Eventual delivery holds within the settling window or when local wins
(\S\ref{sec.design.partitions.hardforks}), which is a deliberate decision to
protect active forums from outdated branches.
%

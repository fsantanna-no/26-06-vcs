...
each.
Note that the tax discourages cycling \reps among colluding identities.
...
eliminates the incentives from malicious members to invite Sybils into the
system.
The only way to generate new \reps is to post content that other members

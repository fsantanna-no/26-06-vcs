...
consistency and self-certified archives~\cite{p2p.merkle-crdts,p2p.byz}, and
...
on ordering still require human intervention (\emph{quasi-CRDTs}), such as
manual merges in version control systems.
%
...
%
Since the proposed consensus mechanism already relies on human interactions,
\FC uses it to address permissionless writes and to provide a total order for
applications (at the cost of rollbacks), which can resolve such conflicts
automatically.

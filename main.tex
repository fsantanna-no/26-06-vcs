...
Yet another possibility is that both branches are legitimate but were genuinely
disconnected for a long period.
In either case, it is unacceptable that honest members of an active forum are
affected.
%
Therefore, considering that forging long branches or returning from long
absences are indistinguishable, reputation alone becomes a fragile criterion
for consensus.

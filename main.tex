...
%
When merging, these fake members would become legitimate and hold the majority
of \reps in the forum.
...
consensus, which ignores the new remote \reps, members in the local branch
(with more reputation) can still react, even \emph{a posteriori}.
%
...
they control the majority of \reps in the common history.
%
...
for consensus.
As the counterpoint illustrates, past members holding the majority of \reps at
any point in time could still override the present, which corresponds to the
\emph{long-range attack} in proof-of-stake~\cite{pos.weak}.

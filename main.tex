...
We highlight four main contributions (in bold):
%
We recognize human-authored content as a scarce resource, and reward members
with reputation tokens as a \textbf{proof-of-authoring} (akin to Bitcoin's
mining).
%
Members can spend these tokens to rate posts, and even revoke abusive content,
as a \textbf{decentralized moderation} process.
%
...
etiquette.
%
Under network partitions, posts form a causal graph, and a \textbf{reputation

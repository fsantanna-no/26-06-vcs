...
The next sequence of commands simulates a peer \emph{X} that
    ...
    (iii) query its payload and metadata.
...
The post metadata includes the action type, local creation time, and a
...
chain.
The example chain repository contains two commits with

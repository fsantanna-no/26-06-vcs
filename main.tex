...
\item Section~\ref{sec.consensus.design}
    describes the overall reputation and consensus mechanisms, which can be
    applied to other systems using Merkle DAGs.
\item Section~\ref{sec.consensus.chains}
    describes the concrete reputation rules we implemented in \FC.
\item Section~\ref{sec.consensus.algo}
    details the consensus algorithm.
\end{itemize}
...
peer-to-peer systems, and set them as pioneers of a new, Sybil-resistant
...
Note that when peer \emph{J} clones \emph{/chat}, it acknowledges its initial

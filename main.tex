...
%
We implement \FC on top of unmodified Git, relying only on hooks to add
...
replication.
%
Then, relying only on non-intrusive hooks, we add what Git alone cannot
provide: reputation, moderation, and consensus.

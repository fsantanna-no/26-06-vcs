...
multi-user forum, but restricted to a single trusted server ordering messages
(e.g., federated protocols~\cite{p2p.ecosystem}).
%
...
Our proposal addresses \emph{multi-user/multi-node} consensus, in which forums
are ordered consistently across all machines with no trusted authority, i.e., a
permissionless counterpart of IRC/Discord or Usenet/Reddit.

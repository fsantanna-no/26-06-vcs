...
The monotonic timeline counts how new an action is in the local order rather
than how old it claims to be.
...
As a minor caveat, idle forums never settle their most recent actions.

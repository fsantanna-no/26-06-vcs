...
timestamp within reasonable bounds:
    no older than its newest parent, and
...
%
The lower limit (\code{parents-1h}) depends only on timestamps from parents
already in the chain, so its validation is deterministic across peers.
%

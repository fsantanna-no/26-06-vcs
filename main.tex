...
refer throughout the examples.
For instance, \R{1.a} determines that pioneers split \nreps{50k} at creation
time, resulting in \nreps{25k} for each of \emph{Alice} and \emph{Bob}.
...
A reputed member can target the new member directly with a like, which requires
previous contact between them.
The more interesting case is to use a \emph{begging post}, which parks outside
the DAG waiting for approval of any reputed member.
%
The next example illustrates the two mechanisms:

{\footnotesize
\begin{verbatim}
 $ fc /chat like author charlie --sign=alice
 TODO

 $ fc /chat post 'like me' --sign=dave --beg
 TODO
 $ fc /chat like post TODO --sign=bob
 TODO
...
TODO: restricted reach


propose two complementary xxx to welcome user
F2F

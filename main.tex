...
that replicates \emph{X} through the \code{clone} operation:
...
In local-first applications, each replica may evolve separately and synchronize
...
Another aspect that Merkle DAGs alone cannot provide is Sybil resistance.

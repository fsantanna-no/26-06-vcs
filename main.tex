...
\code{dag}        & Shows chain DAG         & \code{log --graph}     \\
\hline
\end{tabular}
\caption{Basic \code{fc} commands as Git \emph{façade}.}
\label{tab.commands}
\end{table}
...
Table~\ref{tab.commands} lists the basic operations of \FC, which guide the

...
Peers that first receive the winning branch just append the losing one,
otherwise they must reorder actions after the fork point, similarly to a
blockchain reorganization.
Legitimate actions that are erased must be reposted by their authors, which
should be rare, since members are expected to gossip among themselves often.

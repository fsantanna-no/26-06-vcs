...
\begin{lstlisting}[
    float=tbp,
    label={lst.welcome},
    caption={Member admissions through likes and begging posts.}
]
...
\begin{lstlisting}[
    float=tbp,
    label={lst.poa},
    caption={Proof-of-authoring: author reputation over time.}
]
...
\begin{lstlisting}[
    float=tbp,
    label={lst.double},
    caption={Rejected double-spend on peers \emph{I} and \emph{J}.}
]

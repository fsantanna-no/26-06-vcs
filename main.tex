...
valuable in itself.
%
The outcome is a deterministic function of the common history, so peers holding
the same branches compute it locally in the same way, without further votes or
coordination.

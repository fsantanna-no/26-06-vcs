...
\hline
Emission    & 1.a & pioneers & Chain creation counts $+$\nreps{50K} equally distributed between the pioneers \\
            & 1.b & old post & Consolidated post counts $+$\nreps{1K} to its author, at most once a day \\
\hline
...
\caption {
    ...
    The chosen constants (e.g., \nreps{50K}, \emph{24h}) are arbitrary and
...
tax: \emph{Alice} spends \nreps{5000} and \emph{Charlie} receives \nreps{4500}.

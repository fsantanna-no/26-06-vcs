...
As a main limitation, because forums are DAGs, members that hold 50\% of the
reputation at any old forking point can impose forks that would affect the
consensus.
As a countermeasure, forks older than 100 posts or 7 days are rejected by the
network, whereas newer forks that are malicious require manual intervention.
%
...
\\
         & 1.b & old post &
Consolidated post counts \nreps{+1K} to author, after 24h, at most once a day.
\\
\hline
Expense  & 2   & new post &
New post counts \nreps{-500} to author temporarily, refunded within 12h.
\\
\hline
Transfer &     & tax      &
...
\\
            & 4.b & max  &
Authors are limited to at most \nreps{50K}.
\\
            & 4.c & size &
...
\subsubsection{Forks and Double-spends}
...
In Listing~\ref{lst.double.attempt}, \emph{Charlie} tries to double-spend his
...
\subsubsection{Consensus and Total Order}
...
%
Rule~\code{4.a} requires that authors have at least \nreps{500} to post,

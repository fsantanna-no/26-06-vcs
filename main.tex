...
The design parallels Bitcoin:
    ...
    likes and dislikes transfer reputation (cf. transactions), and
...
As a countermeasure, branches older than a threshold (7 days) cannot reorder
the local history, while newer malicious branches may require manual
intervention, but of only a few honest members.
%

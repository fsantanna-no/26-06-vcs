...
distributed among humans, especially in battery-powered devices.
...
\emph{Proof-of-authoring} is still analogous to mining:
    ...
    (ii)  it adds value to growing chain; and
...
started, which represents the value he added to chain in the form of

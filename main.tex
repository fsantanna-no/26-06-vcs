...
In this section, we compare \FC against CRDTs as the underlying data
model~(\S\ref{sec.related.crdts}), peer-to-peer protocols as the underlying
network~(\S\ref{sec.related.p2ps}), and decentralized forums as the closest
applications~(\S\ref{sec.related.apps}).

...
%
Note also that this kind of attack is refutable because, since the common
...
that a further merge removes all posts of \code{branch-1} from the DAG.
%
...
detects a new longest chain. % and disconsiders old posts.
%
...
The activity threshold counts backwards, from the latest local post in the
unstable consensus.
...
to elect peers to mint new posts.

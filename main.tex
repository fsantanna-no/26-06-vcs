...
%
Nevertheles, since peers are not trusted a priori, and every action is part of
...
two correct peers from synchronizing directly: it can only withhold what it
holds, or attempt denial of service.

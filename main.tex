...
In summary, as in Bitcoin~\cite{btc.timestamps}, initial action admission is a
...
In summary, unlike classic Byzantine agreement with permissioned
quorums~\cite{p2p.byz}, in \FC nothing is decided by counting peers, only by
validating each action locally and ordering branches by the reputation of
their members (\S\ref{sec.design.consensus}).

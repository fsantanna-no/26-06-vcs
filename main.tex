...
We propose a permissionless Sybil-resistant peer-to-peer protocol for public
forums, in which a reputation system moderates content and, at the same time,
delivers network consensus.
...
mechanism, discuss relevant security threats, and evaluate it on real forum
archives.
...
- CONCLUSION
Our main contribution is to make decentralized forums viable in
practice.
...
If this decision is left to At the application level (e.g., end-user filters), does not eliminate traffic
...
author publishes a post to a chain, which subscribed users eventually
receive.

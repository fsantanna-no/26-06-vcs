...
that rejects \code{branch-1}, i.e., a single refutal is sufficient to
propagate.
...
without that synchronize

Therefore, a minority attack to farm new \reps is innocuous because it is

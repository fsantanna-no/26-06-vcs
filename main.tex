...
By public forums we mean any collaborative environment with multiple readers
and writers, such as chats, message boards, wikis, and code repositories.
%
In an ideal forum, all contributions (posts)
(i)   reach all users,
...
Gossiping protocols disseminate posts among peers, but does not guarantee
consensus due to conflicting delivery orders~\cite{p2p.intention,p2p.crdts}.
%
...
consensus~\cite{permissionless} by demanding a scarce resource to write to its
timeline (proof-of-work~\cite{hashcash}), thereby resisting Sybils.
%
...
We adapt proof-of-work's idea to resist Sybils and reach consensus, but now in
...
from chats to wiki articles, and (TODO : results : local post time, sync time,
disk size, etc).

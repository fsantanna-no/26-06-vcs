...
maybe members $a$ and $b$ are the ones who have abandoned the forum for months,
...
%
Yet another possibility is that both branches are legitimate but were really
...
reorder freely.
So, if consensus would reorder local frozen posts, then the merge is simply
refused and the peers are no longer compatible, which is equivalent to a hard
fork of Bitcoin.

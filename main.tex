...
%
Revocation is reversible through \emph{unrevoke} (ln~6--9), and likes also
count towards restoring a payload, so its availability follows the balance
between revokes and unrevokes.
...
%
The last rule, which is analogous to a hard fork in Bitcoin, makes the syncing

...
\item [\S\ref{sec.design.partitions.farming}]
    Reputation Farming:
    how the common history bounds \reps minted in isolation.
...
A \emph{Byzantine} peer~\cite{lamport.byz} may serve forged actions, withhold
...
%
Therefore, a Byzantine peer cannot alter the DAG, forge content, or prevent
other peers from synchronizing directly: it can only deny service, simulating
a partition that correct peers route around.

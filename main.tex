...
%
Therefore, our concept of permissionless forums is not that anyone can post at
...
Once initialized, the only way to welcome new members is through \emph{likes},
which transfer \reps between identities.
%
We propose two complementary mechanisms:
    (i) \emph{friend-to-friend} likes targeting known newcomers directly; and
    (ii) \emph{begging posts} from newcomers waiting for members' likes.

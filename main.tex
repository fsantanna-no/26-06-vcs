...
\emph{Charlie}'s reputation evolves with a post:
%
\begin{description}
...
In Listing~\ref{lst.double}, \emph{Charlie} double-spends most of his \reps
with concurrent likes to \emph{Xion} and \emph{York} on peers \emph{I} and
\emph{J}, just before they synchronize.
%

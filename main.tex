...
establish consensus.
As an application example, we prototype a permissionless Wiki platform that,
based on consensus, resolves conflicts automatically.
\end{abstract}
...
A dVCS is relevant because
    ...
    (iii) with merges that require human intervention, which we propose to
          automate.
%
Hence, as a fifth contribution, we show how the consensus mechanism can empower
...
mechanism, discuss relevant security threats, and evaluate its perfomance.

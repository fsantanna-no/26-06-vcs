...
We propose a permissionless peer-to-peer protocol with four main contributions:
%
\begin{description}
...
which can further rate other posts with likes and dislikes.
...
%
\item [Unbounded sybil-resistant forums:]
Users can create diversified forums of interest ---not a singleton forum---
each as an independent timeline with its own subjective authoring etiquette.
Unlike proof-of-work, which is extrinsic, reputation tokens are intrinsic to
each forum.
%
\item [Decentralized Moderation:]
Users can rate and revoke posts without compromising the integrity of the

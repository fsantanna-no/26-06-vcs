...
Therefore, a Byzantine peer cannot impose forged content, or prevent other
peers from synchronizing directly: it can only deny service, simulating a
partition that correct peers can still route around.
